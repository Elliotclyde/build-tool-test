...
This was pulled down from https://unpkg.com/browse/react-router-dom@5.2.0/esm/react-router-dom.js

And edited until it fully worked in the browser - includeing replacing the React import 
with an import from es-react.
...
var NavLink = forwardRef$1(function (_ref, forwardedRef) {
  ...
  return React.createElement(
    ...
    function (context) {
      !context
        ? process.env.NODE_ENV !== "production"
          ? invariant(false, "You should not use <NavLink> outside a <Router>")
          : invariant(false)
        : void 0;
